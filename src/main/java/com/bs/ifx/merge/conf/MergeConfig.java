...
public class MergeConfig {
    ...
    public static final String DATETIME_XSD = "datetime-types";
    public static final String CODETYPE_XSD = "code-types";
    public static final String ADDRTYPE_XSD = "addr-types";
